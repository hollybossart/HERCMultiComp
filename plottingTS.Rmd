---
title: "Exploratory Volatility and Pricing Plotting"
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(alibaba$OPENPRC, alibaba$ASKHI, alibaba$BIDLO, alibaba$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(pg$OPENPRC, pg$ASKHI, pg$BIDLO, pg$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(pfizer$OPENPRC, pfizer$ASKHI, pfizer$BIDLO, pfizer$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(johnson$OPENPRC, johnson$ASKHI, johnson$BIDLO, johnson$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(disney$OPENPRC, disney$ASKHI, disney$BIDLO, disney$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(wellsfargo$OPENPRC, wellsfargo$ASKHI, wellsfargo$BIDLO, wellsfargo$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(jpmorgan$OPENPRC, jpmorgan$ASKHI, jpmorgan$BIDLO, jpmorgan$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(walmart$OPENPRC, walmart$ASKHI, walmart$BIDLO, walmart$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(intel$OPENPRC, intel$ASKHI, intel$BIDLO, intel$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(bankofa$OPENPRC, bankofa$ASKHI, bankofa$BIDLO, bankofa$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(verizon$OPENPRC, verizon$ASKHI, verizon$BIDLO, verizon$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(att$OPENPRC, att$ASKHI, att$BIDLO, att$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(homedep$OPENPRC, homedep$ASKHI, homedep$BIDLO, homedep$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(citi$OPENPRC, citi$ASKHI, citi$BIDLO, citi$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(amazon$OPENPRC, amazon$ASKHI, amazon$BIDLO, amazon$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(chinamob$OPENPRC, chinamob$ASKHI, chinamob$BIDLO, chinamob$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(taiwan$OPENPRC, taiwan$ASKHI, taiwan$BIDLO, taiwan$PRC))
par(mfrow=c(1,1), mex=0.75)
...
#### Summary of Volatility Data
```{r, echo=FALSE}
summary(garmanklassTA(novartis$OPENPRC, novartis$ASKHI, novartis$BIDLO, novartis$PRC))
par(mfrow=c(1,1), mex=0.75)
