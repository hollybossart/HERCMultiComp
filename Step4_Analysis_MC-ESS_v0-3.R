...
### Dataset for the period 1 -- arranged in order of d parameter smallest to largest
# see bst_models.v0-2 for sorted part 1 data based on d parameter in ARFIMA models
data.Volatility_prd.1 <- cbind.data.frame(v.t_taiwan_1,
                                          v.t_att_1,
                                          v.t_verizon_1,
                                          v.t_johnson_1,
                                          v.t_apple_1,
